        ...
        <div className="container mx-auto px-4 py-16 md:py-20 relative z-10">
          ...
          >
            <motion.span
              ...
              viewport={{ once: true }}
              className="inline-block text-rose-500 font-medium text-base md:text-lg"
            >
              இடம்
            </motion.span>
            ...
            <motion.h2
              ...
              viewport={{ once: true }}
              className="text-3xl sm:text-4xl md:text-5xl font-serif text-gray-800"
            >
              மதுரை
            </motion.h2>
            ...
            >
              <div className="h-[1px] w-8 sm:w-12 bg-rose-200" />
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              className="w-full h-[250px] sm:h-[350px] md:h-[400px] rounded-2xl overflow-hidden shadow-lg border-8 border-white"
            >
              <iframe
                ...
                <div className="space-y-4 text-sm sm:text-base">
                  ...
                  <div className="pt-4">
                    <motion.a
                      ...
                      whileTap={{ scale: 0.98 }}
                      viewport={{ once: true }}
                      className="w-full flex items-center justify-center gap-1.5 bg-white text-gray-700 px-4 py-2 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors text-sm font-semibold"
                    >
